...
<RegisterOperation kind="vfslide1down" initial-direction="down" :slide-one="true" :allow-direction-change="false" insert-label="f[rs1]" instruction="vfslide1down.vf v0, v8, fa0" />

## 元素语义

```text
vstart <= i < vl-1: vd[i] = vs2[i + 1]
vstart <= i = vl-1: vd[i] = f[rs1]
```
...
<InstructionPseudocode kind="vfslide1down" />
