...
date: 2026-08-30
topic: "汇编与系统"
keywords: ["RISC-V", "RVV 1.0", "vrgatherei16"]
---

<script setup>
const instructionParts = [
  { text: 'vrgatherei16.vv', label: '指令助记符', kind: 'mnemonic', description: 'vrgatherei16.vv：16 位索引收集' },
...
<InstructionSlots opcode="V 1.0 · 见官方编码表" full-name="vrgatherei16.vv：16 位索引收集" instruction-set="RISC-V V 1.0" :parts="instructionParts" :reference="{ href: 'https://docs.riscv.org/reference/isa/v20260120/unpriv/v-st-ext.html', label: 'RISC-V V 1.0' }" />

<RegisterOperation kind="vrgatherei16" architecture="riscv" operation-class="permute" instruction="vrgatherei16.vv v0, v8, v12" />
...
<InstructionPseudocode kind="vrgatherei16" />
