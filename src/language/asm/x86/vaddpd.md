...
下图以圆点表示位分组。点击 `k1` 的各位可以启用或屏蔽对应 lane，并可切换合并与 `{z}` 零化策略。

<MaskedLaneOperation
  :left="[10, 20, 30, 40, 50, 60, 70, 80]"
  :right="[1, 2, 3, 4, 5, 6, 7, 8]"
  :old-destination="[99, 99, 99, 99, 99, 99, 99, 99]"
...
__m512d all_lanes(__m512d a, __m512d b) {
    return _mm512_add_pd(a, b);
}

__m512d merge_mask(__m512d old, __mmask8 k, __m512d a, __m512d b) {
    return _mm512_mask_add_pd(old, k, a, b);
}

__m512d zero_mask(__mmask8 k, __m512d a, __m512d b) {
