...
1. 从[类与对象](/lang/cxx/oop/class)理解构造、析构和特殊成员函数。
2. 通过[右值引用](/lang/cxx/0x/rvalue_ref)与[复制消除](/lang/cxx/17/copy_elision)理解值类别和对象传递。
3. 学习 `unique_ptr`、`shared_ptr`、`weak_ptr`，建立清晰的所有权模型。
4. 从 [STL 导览](/lang/cxx/stl/)进入容器、迭代器和算法。
5. 从[流体系](/lang/cxx/stream/)理解格式状态、缓冲区与文件 I/O。
